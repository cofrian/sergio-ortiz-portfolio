        ...
        messages: [
          {
            ...
            content: [
              ...
              "Do not use general knowledge, infer missing achievements, transform possibilities into facts, or claim Sergio authored a fork unless the evidence says so. Never fill an evidence gap with phrases such as 'can be inferred' or 'se puede inferir'; state that the evidence is insufficient instead.",
